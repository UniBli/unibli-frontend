...
const NavBar = ({isAuthenticated, origin, integrado2}) => {
    ...
    return (
            <Navbar className={styles.navbar}>
                ...
                {isAuthenticated ? <MenuHamburger origin={origin} integrado2={integrado2}/> : <LoginButton className={styles.loginButton}/>  }              
            </Navbar>
    );
};
